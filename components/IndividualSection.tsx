...
export default function IndividualSection() {
  return (
    <main className="bg-[var(--blue-50)] text-[var(--text-main)]">
      ...
      <motion.section
        className="relative h-96 flex items-center justify-center bg-[url('/images/individual-header.jpg')] bg-cover bg-center shadow-inner shadow-black/50"
        initial="hidden"
        animate="visible"
        variants={fadeInUp}
      >
      ...
      >
        <div className="space-y-4">
          <h2 className="text-3xl font-bold">¿Qué es la incineración individual?</h2>
          <p className="leading-relaxed opacity-90">
            La <strong>incineración individual</strong> te ofrece un servicio exclusivo para tu mascota:
            incluye urna personalizada, certificado y carta de duelo, con posibilidad de asistir al proceso.
          </p>
        ...
        <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden shadow-lg">
          <Image
            ...
            alt="Detalle de urna personalizada"
            fill
      ...
      >
        <div className="mx-auto max-w-xs">
          ...
          <p className="mb-6 text-lg font-medium">
            ¿Quieres un adiós más personalizado y exclusivo?
          </p>
          <a
            href="/contacto"
